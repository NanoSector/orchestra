...
final class MakeApiController extends AbstractMaker
{
    ...
    public function configureCommand(Command $command, InputConfiguration $inputConfig): void
    {
        $command
            ...
            ->addOption('no-template', null, InputOption::VALUE_NONE, 'Use this option to disable template generation (will always be overwritten with true for API controllers!)')
